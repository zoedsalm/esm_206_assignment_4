...
ggplot(data = lobster_abund) +
  geom_histogram(aes(x = year, fill = site, alpha = 0.7, color = site, binwidth = 10),
                 show.legend = FALSE) +
...
ggplot(lobster_mean_12, aes(x = protection, y = mean_size))+
  geom_col(lobster_mean_18, aes(x = protection, y = mean_size))
