...
Mean size (mm) for 2018 MPA sites (`r round(MPA_2018$estimate[1],2)`) and non-MPA sites (`r round(nonMPA_2018$estimate[2],2)`) in the year differ significantly (t(`r round(protection_2018$parameter,2)`) = (`r round(protection_2018$statistic,2)`, *p* = (`r round(protection_2018$p.value,2)`).
